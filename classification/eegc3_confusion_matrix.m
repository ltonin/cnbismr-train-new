function [ConfMatClass ConfMatAll Accuracy Error] = eegc3_confusion_matrix(TrueLabels, FoundLabels)
...
if(~isequal(Classes,[1:NClass]) && ~isequal(Classes,[1:NClass]'))
    disp('[eegc3_confusion_matrix] Classes must be a vector [1:N] or [1:N]');
end
