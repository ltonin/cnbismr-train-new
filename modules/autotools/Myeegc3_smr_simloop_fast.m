function bci = Myeegc3_smr_simloop_fast(filexdf, filetxt, filemat, ... 
...
output_simloop = data;
name = 'Data_simloop';
save(['/homes/vliakoni/Results_LDA_Offline/' name '.mat'], 'output_simloop');
...
printf('[eegc3_smr_simloop] Saving SMR-BCI structure: %s\n', ...
	['/homes/vliakoni/Results_LDA_Offline/' name '.mat']);
save(['/homes/vliakoni/Results_LDA_Offline/' name '.mat'], 'bci');
% printf('[eegc3_smr_simloop] Saving SMR-BCI structure: %s\n', ...
