function [lda, auc] = Myeegc3_train_lda_New(settings, data, labels, trial, SubID, sessionNum)
...
saveas(figNum,['/homes/vliakoni/Results_LDA_Offline/' SubID{1,1} '_' 'Session' num2str(sessionNum) '.png'])
