% function [MI nMI info] = eegc3_smr_erx(eeg, winsize, trial_idx, settings, ...
%    protocol, taskset, bands)
%
%
%
% Function to plot the ERD/S maps of all channels
%
% Inputs: 
% 
...
function [MI nMI info] = eegc3_smr_erx(eeg, trial_idx, labels, winsize, settings, ...
    protocol, taskset, bands)
